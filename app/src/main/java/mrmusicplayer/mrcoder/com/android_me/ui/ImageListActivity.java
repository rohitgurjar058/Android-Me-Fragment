...
import mrmusicplayer.mrcoder.com.android_me.MainActivity;
import mrmusicplayer.mrcoder.com.android_me.R;

public class ImageListActivity extends AppCompatActivity implements MasterListFragment.OnImageClickListener{
    ...
    //5 Define the behaviour for onImageSelected; create a toast that displays position selected
    @Override
